// https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=3976

// UVA 12531 - Hours and Minutes

// Heidi has a discrete analog clock in the shape of a circle, as the one in the
// figure. Two hands rotate around the center of the circle, indicating hours
// and minutes. The clock has 60 marks placed around its perimeter, with the
// distance between consecutive marks being constant.
// The minute hand moves from its current mark to the next exactly once
// every minute. The hour hand moves from its current mark to the next exactly
// once every 12 minutes, so it advances five marks each hour.
// We consider that both hands move discretely and instantly, which means
// they are always positioned exactly over one of the marks and never in between
// marks.
...
// Heidi’s list indicates that both at three o’clock and at nine o’clock the minimum angle between the two
